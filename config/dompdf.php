...
return [
    ...
    */
    ...
    'options' => [
        ...
        'fonts' => ['calibri' => [
                'normal' => public_path('fonts/Calibri.ttf'),
                'bold' => public_path('fonts/calibrib.ttf'),
                'italic' => public_path('fonts/calibrii.ttf'),
                'bold_italic' => public_path('fonts/calibril.ttf'),
            ]],
        /**
