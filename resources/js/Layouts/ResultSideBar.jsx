...
export default function ResultSideBar({ header, children, users, tasks, selectedFilter, setSelectedFilter }) {
  ...
  const teams = [
    ...
    { key: "marketing", label: "Marketing", description: "Marketing campaigns", route: route("marketing_review.index"), color: "bg-blue-500" },
        ...
        <div className="absolute inset-0 bg-white border-r border-gray-200">
          ...
          <div className="overflow-y-auto h-[calc(100vh-4rem)] py-4">
            ...
            <div className="px-4 mb-6">
              <div className={`flex items-center ${isCollapsed ? 'justify-center' : ""} text-gray-500 mb-3`}>
