...
export default function TaskSideBar({ header, children, users, tasks, selectedFilter, setSelectedFilter, selectedUser, setSelectedUser, sortDeadline, setSortDeadline, selectedCompany, setSelectedCompany }) {
  ...
  const task_status = [
    { key: "", label: "All Tasks", count: taskCounts.all, color: "bg-blue-100 text-blue-800", icon: <Circle className="h-4 w-4" /> },
    { key: "In Review", label: "In Review", count: taskCounts.inReview, color: "bg-amber-100 text-amber-800", icon: <Clock className="h-4 w-4" /> },
    { key: "Rejected", label: "Rejected", count: taskCounts.rejected, color: "bg-red-100 text-red-800", icon: <X className="h-4 w-4" /> },
    { key: "Approved", label: "Approved", count: taskCounts.approved, color: "bg-green-100 text-green-800", icon: <CheckCircle className="h-4 w-4" /> },
    { key: "Cancel", label: "Cancelled", count: taskCounts.cancel, color: "bg-gray-100 text-gray-800", icon: <Slash className="h-4 w-4" /> },
  ];

  const teams = [
    { key: "media", label: "Media Team", description: "Editor, Video & Photographer", route: route("media.index"), color: "bg-purple-500" },
    { key: "creative", label: "Creative Team", description: "Design", route: route("creative.index"), color: "bg-pink-500" },
    { key: "marketing", label: "Marketing", description: "Marketing campaigns", route: route("marketing.index"), color: "bg-blue-500" },
