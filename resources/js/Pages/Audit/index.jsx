...
export default function AuditIndex({ audits }) {
    ...
    const getActionColor = (action) => {
        switch (action) {
            case 'Create': return 'bg-green-100 text-green-800 border-green-200 dark:bg-green-900 dark:text-green-300 dark:border-green-800';
            ...
            case 'Submit': return 'bg-yellow-100 text-yellow-800 border-yellow-400 dark:bg-yellow-500 dark:text-yellow-700 dark:border-yellow-800'
