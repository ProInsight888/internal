...
export default function index({ schedule }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route("kalender.update", { kalender: schedule.id }));
    };
                ...
                <div className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white py-10 px-6 rounded-b-2xl shadow-md">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl opacity-90 max-w-2xl mx-auto">
                            Update your event details to keep everything organized and on track
                        </p>
                    </div>
                </div>
            }
            ...
            <div className="py-8 bg-gray-50 min-h-screen">
                <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div className="p-8">
                            <div className="text-2xl font-bold text-gray-800 mb-6">Edit Event</div>
