...
export default function create({ users, category }) {
    ...
    const [showOptionCategory, setShowOptionCategory] = useState(false)
                ...
                <div className="bg-gradient-to-r from-teal-600 to-blue-700 text-white py-10 px-6 rounded-b-2xl shadow-md">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl opacity-90 max-w-2xl mx-auto">
                            Expand your inventory with new items to keep your
                            business well-stocked and organized
                        </p>
                    </div>
                </div>
            }
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onFocus={() =>
                                                setShowOptionCategory(true)
                                            }
                                            onBlur={() =>
                                                setTimeout(
                                                    () =>
                                                        setShowOptionCategory(
                                                            false
                                                        ),
                                                    150
                                                )
                                        ...
                                        {showOptionCategory &&
                                            category.length > 0 && (
                                                <div
                                                    className="absolute z-10 mt-1 w-[15vw] bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 py-2 max-h-32 rounded-[0.5rem] shadow-lg 
